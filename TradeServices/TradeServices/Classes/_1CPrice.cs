...
namespace TradeServices.Classes
{
    public class _1CPrice : _1CUtManager, IResultArray<Price>
    {
        ...
        private const string _1CQuery = @"ВЫБРАТЬ
                                        ...
                                        ИЗ
                                            РегистрСведений.ЦеныНоменклатуры.СрезПоследних(&Дата, ВИдЦены = &priceId и не Номенклатура.ПометкаУдаления и  не Номенклатура.Родитель.ПометкаУдаления) КАК ЦеныНоменклатурыСрезПоследних
                                        ";
        #endregion

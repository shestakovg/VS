...
function loadAllRoutes() {
    $.ajax({
        type: "POST",
        url: "/OutletDestinationValidation/getallroutes",
        ...
        success: function (data) {
           ...
           // console.log(data);
            ...
            //routesData.lastUpdate = d.getTime();
        }
    });
}
...
function getKnownLocation(outletobj) {
    $.ajax({
        type: "POST",
        url: "/OutletDestinationValidation/GetKnownLocation",
...
function approveBtnClick() {
    ...
    $.ajax({
        type: "POST",
        url: "/OutletDestinationValidation/SaveApprovedLocation",
